...
impl FreeTypeRasterizer {
    ...
    fn ft_load_flags(pat: &fc::Pattern) -> freetype::face::LoadFlag {
        ...
        match (antialias, hinting, rgba) {
            (false, fc::HintStyle::None, _) => freetype::face::LoadFlag::NO_HINTING | freetype::face::LoadFlag::MONOCHROME,
            (false, _, _) => freetype::face::LoadFlag::TARGET_MONO | freetype::face::LoadFlag::MONOCHROME,
            (true, fc::HintStyle::None, _) => freetype::face::LoadFlag::NO_HINTING | freetype::face::LoadFlag::TARGET_NORMAL,
            ...
            (true, _, fc::Rgba::Rgb) |
            (true, _, fc::Rgba::Bgr) => freetype::face::LoadFlag::TARGET_LCD,
            (true, _, fc::Rgba::Vrgb) |
            (true, _, fc::Rgba::Vbgr) => freetype::face::LoadFlag::TARGET_LCD_V,
